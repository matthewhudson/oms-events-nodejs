# _Your Microservice with Events_ Open Microservice
...
> Subscribe to heartbeat events from different users
##### Action Arguments

| Argument Name | Type | Required | Default | Description |
|:------------- |:---- |:-------- |:--------|:----------- |
| user | `string` | `false` | None | No description provided. |


``` shell
oms subscribe heartbeat \ 
    -a user='*****'
```

##### publish

> Publish an event to your service
##### Action Arguments

| Argument Name | Type | Required | Default | Description |
|:------------- |:---- |:-------- |:--------|:----------- |
| eventName | `string` | `true` | None | No description provided. |
| user | `string` | `false` | None | Select to which user to send the event |
| data | `map` | `true` | None | No description provided. |
...
[![Edit oms-events-nodejs on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/oms-services/oms-events-nodejs)
